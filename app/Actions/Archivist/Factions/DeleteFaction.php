...
final readonly class DeleteFaction extends WriteApiAction
{
    ...
    protected function successData(ValidatedInput $input, Response $response): SuccessData
    {
        return new SuccessData([
            ...
            'id' => $input->string('faction_id')->toString(),
        ]);
    }

    protected function request(ValidatedInput $input): Response
    {
        return $this->client->delete("/v1/factions/{$input->string('faction_id')}");
    }
