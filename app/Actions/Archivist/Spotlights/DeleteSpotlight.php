...
final readonly class DeleteSpotlight extends WriteApiAction
{
    ...
    protected function successData(ValidatedInput $input, Response $response): SuccessData
    {
        return new SuccessData([
            ...
            'id' => $input->string('spotlight_id')->toString(),
        ]);
    }

    protected function request(ValidatedInput $input): Response
    {
        return $this->client->delete("/v1/spotlights/{$input->string('spotlight_id')}");
    }
