...
final class CampaignStatsAndSessionReviewTest extends FeatureTestCase
{
    ...
    #[Test]
    public function campaign_stats_preserves_original_count_when_character_lookup_is_forbidden(): void
    {
        Http::fake([
            self::BASE_URL.'/v1/campaigns/camp_1/stats' => Http::response([
                'campaign_id' => 'camp_1',
        ...
        $this->assertInstanceOf(CampaignStatsData::class, $result);
        $this->assertSame(34, $result->get('characters'));
        $this->assertSame(2, $result->get('sessions'));
        $this->assertSame(5, $result->get('moments'));
    }

    #[Test]
    public function campaign_stats_preserves_original_count_when_character_lookup_cannot_connect(): void
    {
        Http::fake([
            self::BASE_URL.'/v1/campaigns/camp_1/stats' => Http::response([
                'campaign_id' => 'camp_1',
            ...
            self::BASE_URL.'/v1/characters*' => function () {
